...
void preencher_array(int array[], int tam_array);
float ordenar_bubble_sort(int array[], int tam_array);
...
void apresentacao(){
  ...
  Sleep(1000);
  printf("\n\n\n\n\n\n\t\t\t\t Integrantes  \n");
  printf("\n\t\t\t\t Padawan: Sávio Ferreira De Castro..\n");
  printf("\t\t\t\t Padawan: Lucas Nunes Carvalho..\n");
  Sleep(1000);
  system("cls");
  ...
  while (true){
    ...
    switch (tela_menu()){
        ...
        case 6:
            ...
            if (teste == false){
                printf("Preencha o array primeiro");
            }
